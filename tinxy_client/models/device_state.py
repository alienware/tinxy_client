...
class DeviceState(BaseModel):
    ...
    DeviceState
    """ # noqa: E501
    state: Optional[StrictStr] = Field(default=None, description="Device state ON / OFF")
    ...
    status: Optional[StrictInt] = Field(default=None, description="1 - Online 0 - Offline")
    __properties: ClassVar[List[str]] = ["state", "brightness", "status"]
