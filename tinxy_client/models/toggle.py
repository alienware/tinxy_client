...
class Toggle(BaseModel):
    ...
    Toggle
    """ # noqa: E501
    request: Optional[ToggleRequest] = None
    device_number: Optional[StrictInt] = Field(default=None, description="Device Number. You can get the device number from the `devices` section start from 1 for each item", alias="deviceNumber")
    __properties: ClassVar[List[str]] = ["request", "deviceNumber"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "request": ToggleRequest.from_dict(obj["request"]) if obj.get("request") is not None else None,
