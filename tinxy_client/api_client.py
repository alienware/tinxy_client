...
from tinxy_client.api_response import ApiResponse, T as ApiResponseT
import tinxy_client.models
from tinxy_client import rest
from tinxy_client.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(tinxy_client.models, klass)
